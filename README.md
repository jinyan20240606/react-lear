...
2. 后续的一些研究方向，react的一些APi，钩子原理研究总结，react一些应用插件的源码实现，react源码关键模块的手写实现，
   1. 看一些相关面试题能不能hover
...
- [react-learn](#react-learn)
  ...
  - [react17学习](#react17学习)
    ...
    - [常见数据结构](#常见数据结构)
    - [调试源码](#调试源码)
      - [改动了react源码后续进行增量调试](#改动了react源码后续进行增量调试)
    - [状态更新流程](#状态更新流程)
      - [状态更新刨析](#状态更新刨析)
        - [与状态相关有 4 个属性: --- 静态能力](#与状态相关有-4-个属性-----静态能力)
        - [副作用 --- 动态能力](#副作用-----动态能力)
    - [深入理解优先级](#深入理解优先级)
    - [fiber树构造](#fiber树构造)
      - [整体数据结构变化](#整体数据结构变化)
      ...
      - [对比更新](#对比更新)
        - [更新入口](#更新入口)
        - [更新的构造阶段](#更新的构造阶段)
          - [markUpdateLaneFromFiberToRoot](#markupdatelanefromfibertoroot)
          - [工作循环构造](#工作循环构造)
          - [探寻阶段 beginWork](#探寻阶段-beginwork)
    ...
    - [状态更新API入手](#状态更新api入手)
      ...
      - [函数组件的dispatchAction](#函数组件的dispatchaction)
    - [其他API入手](#其他api入手)
    ...
    - [Hooks源码刨析](#hooks源码刨析)
      ...
      - [hook原理概览](#hook原理概览)
        ...
        - [hook分类](#hook分类)
        - [调用function前](#调用function前)
        - [全局变量](#全局变量)
        - [renderWithHooks解读](#renderwithhooks解读)
        - [调用function](#调用function)
        - [总结](#总结-1)
    ...
    - [react合成事件](#react合成事件)
      - [问题和优化点](#问题和优化点)
      - [事件绑定](#事件绑定)
        - [统一的原生listener封装](#统一的原生listener封装)
          - [createEventListenerWrapperWithPriority方法](#createeventlistenerwrapperwithpriority方法)
        - [总结](#总结-3)
      - [事件触发：dispatchEvent](#事件触发dispatchevent)
        - [背景](#背景)
